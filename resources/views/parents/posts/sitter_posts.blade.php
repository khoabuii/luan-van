    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="{{asset('parent/sitter_profile/')}}/{{$sitter[0]->id}}">
                    <span style="color: rgb(161, 79, 31)">{{$sitter[0]->name}}</span>
                </a></h1>
            </div>
            <div class="col-md-6">
                @include('noti.errors')
                        ...
                        <header class="">
                            ...
                            <div class="entry-meta">
                                <span class="entry-author"><i class="fa fa-user"></i>
                                    <a href="{{asset('parent/sitter_profile/')}}/{{$post->sitter}}">{{$sitter[0]->name}}
                                    </a>
                                </span>
